...
export const Blogs = () => {
  return (
    <div className="pt-10 pb-10 bg-gray-300/20 mt-2">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="font-manrope text-4xl font-bold text-white text-center mb-16">
          Our latest blog
        </h2>
        <div className="flex justify-center  gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
          <div className="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl bg-white">
      ...
      <p className="text-center mt-10">© 2024 NextJS Blog.</p>
    </div>
  );
};
